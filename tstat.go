...
// Cover creates a new CoverageParser from a coverage profile. The corresponding function profile will be generated
// automatically. If you want to provide an existing function profile, use CoverFromReaders. The cover profile must be
// a valid coverage profile generated by `go test -coverprofile=cover.out`.
